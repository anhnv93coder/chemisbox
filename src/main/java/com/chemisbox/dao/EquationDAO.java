...
public interface EquationDAO {
	public List<Equation> selectByChemical(String chemical, int startIndex,
			int pageSize) throws ChemisboxException;

	public List<Equation> selectByChemical(String chemical, int typeOf,
			int startIndex, int pageSize) throws ChemisboxException;
	...
	public List<Equation> selectByChemicals(String chemical1, String chemical2,
			String chemical3, int typeOf, int startIndex, int pageSize)
	...
	public List<Equation> searchByKeyWord(String keyWord, int startIndex,
			int pageSize) throws ChemisboxException;
